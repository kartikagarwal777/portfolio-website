...
const MobileMenu = ({ isScrolled }: MobileMenuProps) => {
  ...
  return (
    <div className="sm:hidden">
      ...
      {/* Menu */}
      <div
        className={`fixed inset-0 z-[51] h-screen w-full transform overflow-y-auto bg-white/95 shadow-2xl backdrop-blur-md transition-transform duration-300 ease-in-out ${
