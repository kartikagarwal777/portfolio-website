    ...
    <>
      ...
      <main id="main-content" className="relative min-h-screen text-slate-900">
        ...
        <div className="relative pt-28 md:pt-32">
          <section className="pb-20 md:pb-24" aria-labelledby="page-title">
              ...
              <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <h1
                      id="page-title"
                      className="motion-reveal motion-delay-1 text-4xl font-semibold text-slate-900 sm:text-5xl lg:text-6xl"
                    >
                      Kartik Agarwal
                    </h1>
                    <p className="motion-reveal motion-delay-2 max-w-2xl text-lg text-slate-600 sm:text-xl">
                      Alpha quant researcher and former engineering lead building research systems that turn economic
                      intuition, data, and machine learning into scalable investment decisions.
                    </p>
                  </div>
                ...
                <div className="motion-reveal motion-delay-2 surface-panel p-6 sm:p-7">
                  ...
                  <p className="mt-4 text-slate-600">
                    I care about signal quality, economic grounding, and live trading reliability. My work spans idea
                    generation, portfolio construction, and production monitoring pipelines.
                  </p>
